			...
			while($cliente = mysqli_fetch_array($consulta)) {
				...
				$contenido .= '			
		          <tr>
		            ...
		            <td><a href =  "../views/detalles_credito.php?id_cte='.$cliente['id'].'" class="btn-small waves-effect waves-light pink tooltipped" data-position="bottom" data-tooltip="Detalles"><i class="material-icons">credit_card</i></a></td>
