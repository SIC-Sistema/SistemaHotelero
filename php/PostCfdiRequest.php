...
while ($datosReservacion = mysqli_fetch_array($queryImpuestos)) {
    ...
    $razonSocialUper =  mb_strtoupper($datosReceptor['razon_social'], 'UTF-8');
    $arreglodinamico[] = 
      Array  (
...
$facturama = new Facturama\Client($datosEmisor['usuario'], $datosEmisor['password']);
...
$params = [
   ...
   "Receiver" => [
         ...
         "CfdiUse" => $datosReceptor['uso_cfdi'], 
         "Name" => $razonSocialUper, 
         "FiscalRegime" => $datosReceptor['regimen'], 
         "TaxZipCode" => $datosReceptor['codigo_postal'] 
      ], 
