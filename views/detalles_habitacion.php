            ...
            <li class="collection-item avatar">
              ...
              <p class="row col s12"><b>
              	<div class="col s12 m4">
              		<div class="col s12"><b class="indigo-text">N° HABITACION: </b><?php echo $habitacion['id'];?></div>
	        ...
	        <table class="row col s12 m10 l8">
	        	...
	        	<tbody>
	        		<tr>
	        			...
	        			<td><a onclick="" class="btn-small grey darken-3 waves-effect waves-light"><i class="material-icons">edit</i></a></td>
