...
<html lang="en">
  <head>
    ...
    ?>
    <title>San Roman | Clientes</title>
    <script>
  ...
  <body onload="buscar_clientes();">
    <div class="container"><br><br>
      ...
      <a href="add_cliente.php" class="waves-effect waves-light btn grey darken-3 left right">Agregar Cliente<i class="material-icons prefix left">add</i></a><br><br>
        ...
        <form class="col s12 m6 l6">
          <div class="row">
            <div class="input-field col s12">
              ...
              <label for="busqueda">Buscar(N° Cliente, Nombre, RFC, E-Razon Social)</label>
            </div>
          </div>
        </form>
      </div>
